...
#define MOTOR_LEFT_IN1_GPIO GPIO_NUM_26
#define MOTOR_LEFT_IN2_GPIO GPIO_NUM_27

#define MOTOR_RIGHT_EN_GPIO GPIO_NUM_12
#define MOTOR_RIGHT_IN1_GPIO GPIO_NUM_33
#define MOTOR_RIGHT_IN2_GPIO GPIO_NUM_32
